...
| [modern-css-internals.md](modern-css-internals.md) | touch var()/custom properties, @media conditions, vw/vh, calc(), :not(), rem, currentColor, flexbox — how the Tier 1–3A features are wired and their traps |
