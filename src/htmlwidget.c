...
static Tk_ConfigSpec configSpecs[] = {
    ...
    {TK_CONFIG_BORDER, "-background", "background", "Background",
     DEF_HTML_BG_COLOR, offsetof(HtmlWidget, border),
     TK_CONFIG_COLOR_ONLY},
    {TK_CONFIG_BORDER, "-background", "background", "Background",
     DEF_HTML_BG_MONO, offsetof(HtmlWidget, border),
     TK_CONFIG_MONO_ONLY},
    ...
    {TK_CONFIG_PIXELS, "-borderwidth", "borderWidth", "BorderWidth",
     DEF_HTML_BORDER_WIDTH, offsetof(HtmlWidget, borderWidth), 0},
    {TK_CONFIG_ACTIVE_CURSOR, "-cursor", "cursor", "Cursor",
     DEF_HTML_CURSOR, offsetof(HtmlWidget, cursor), TK_CONFIG_NULL_OK},
    {TK_CONFIG_BOOLEAN, "-exportselection", "exportSelection",
     "ExportSelection",
     DEF_HTML_EXPORT_SEL, offsetof(HtmlWidget, exportSelection), 0},
    {TK_CONFIG_SYNONYM, "-fg", "foreground", (char *) NULL,
     (char *) NULL, 0, 0},
    {TK_CONFIG_STRING, "-fontcommand", "fontCommand", "FontCommand",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zFontCommand), 0},
    {TK_CONFIG_STRING, "-fontfamily", "fontFamily", "FontFamily",
     "times", offsetof(HtmlWidget, FontFamily), 0},
    {TK_CONFIG_INT, "-fontadjust", "fontAdjust", "FontAdjust",
     "2", offsetof(HtmlWidget, FontAdjust), 0},
    {TK_CONFIG_INT, "-formpadding", "formPadding", "FormPadding",
     "4", offsetof(HtmlWidget, formPadding), 0},
    {TK_CONFIG_COLOR, "-foreground", "foreground", "Foreground",
     DEF_HTML_FG, offsetof(HtmlWidget, fgColor), 0},
    {TK_CONFIG_STRING, "-imgidxcommand", "imgidxCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zImgIdxCommand), 0},
    {TK_CONFIG_PIXELS, "-height", "height", "Hidth",
     DEF_HTML_HEIGHT, offsetof(HtmlWidget, height), 0},
    {TK_CONFIG_COLOR, "-highlightbackground", "highlightBackground",
     "HighlightBackground", DEF_HTML_HIGHLIGHT_BG,
     offsetof(HtmlWidget, highlightBgColorPtr), 0},
    {TK_CONFIG_COLOR, "-highlightcolor", "highlightColor", "HighlightColor",
     DEF_HTML_HIGHLIGHT, offsetof(HtmlWidget, highlightColorPtr), 0},
    {TK_CONFIG_PIXELS, "-highlightthickness", "highlightThickness",
     "HighlightThickness",
     DEF_HTML_HIGHLIGHT_WIDTH, offsetof(HtmlWidget, highlightWidth), 0},
    {TK_CONFIG_STRING, "-hyperlinkcommand", "hyperlinkCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zHyperlinkCommand), 0},
    {TK_CONFIG_STRING, "-imagecommand", "imageCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zGetImage), 0},
    {TK_CONFIG_STRING, "-bgimagecommand", "BGimageCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zGetBGImage), 0},
    {TK_CONFIG_INT, "-insertofftime", "insertOffTime", "OffTime",
     DEF_HTML_INSERT_OFF_TIME, offsetof(HtmlWidget, insOffTime), 0},
    {TK_CONFIG_INT, "-insertontime", "insertOnTime", "OnTime",
     DEF_HTML_INSERT_ON_TIME, offsetof(HtmlWidget, insOnTime), 0},
    {TK_CONFIG_STRING, "-isvisitedcommand", "isVisitedCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zIsVisited), 0},
    {TK_CONFIG_PIXELS, "-padx", "padX", "Pad",
     DEF_HTML_PADX, offsetof(HtmlWidget, padx), 0},
    {TK_CONFIG_PIXELS, "-pady", "padY", "Pad",
     DEF_HTML_PADY, offsetof(HtmlWidget, pady), 0},
    {TK_CONFIG_PIXELS, "-leftmargin", "leftmargin", "Margin",
     DEF_HTML_PADY, offsetof(HtmlWidget, leftmargin), 0},
    {TK_CONFIG_PIXELS, "-topmargin", "topmargin", "Margin",
     DEF_HTML_PADY, offsetof(HtmlWidget, topmargin), 0},
    {TK_CONFIG_PIXELS, "-marginwidth", "marginwidth", "Margin",
     DEF_HTML_PADY, offsetof(HtmlWidget, marginwidth), 0},
    {TK_CONFIG_PIXELS, "-marginheight", "marginheight", "Margin",
     DEF_HTML_PADY, offsetof(HtmlWidget, marginheight), 0},
    {TK_CONFIG_BOOLEAN, "-overridecolors", "overrideColors",
     "OverrideColors", "0", offsetof(HtmlWidget, overrideColors), 0},
    {TK_CONFIG_BOOLEAN, "-overridefonts", "overrideFonts",
     "OverrideFonts", "0", offsetof(HtmlWidget, overrideFonts), 0},
    {TK_CONFIG_RELIEF, "-relief", "relief", "Relief",
     DEF_HTML_RELIEF, offsetof(HtmlWidget, relief), 0},
    {TK_CONFIG_RELIEF, "-rulerelief", "ruleRelief", "RuleRelief",
     "sunken", offsetof(HtmlWidget, ruleRelief), 0},
    {TK_CONFIG_COLOR, "-selectioncolor", "background", "Background",
     DEF_HTML_SELECTION_COLOR, offsetof(HtmlWidget, selectionColor), 0},
    {TK_CONFIG_RELIEF, "-tablerelief", "tableRelief", "TableRelief",
     "raised", offsetof(HtmlWidget, tableRelief), 0},
    {TK_CONFIG_STRING, "-takefocus", "takeFocus", "TakeFocus",
     DEF_HTML_TAKE_FOCUS, offsetof(HtmlWidget, takeFocus),
     TK_CONFIG_NULL_OK},
    {TK_CONFIG_COLOR, "-unvisitedcolor", "foreground", "Foreground",
     DEF_HTML_UNVISITED, offsetof(HtmlWidget, newLinkColor), 0},
    {TK_CONFIG_BOOLEAN, "-underlinehyperlinks", "underlineHyperlinks",
     "UnderlineHyperlinks", "1", offsetof(HtmlWidget, underlineLinks), 0},
    {TK_CONFIG_COLOR, "-visitedcolor", "foreground", "Foreground",
     DEF_HTML_VISITED, offsetof(HtmlWidget, oldLinkColor), 0},
    {TK_CONFIG_PIXELS, "-width", "width", "Width",
     DEF_HTML_WIDTH, offsetof(HtmlWidget, width), 0},
    {TK_CONFIG_STRING, "-xscrollcommand", "xScrollCommand", "ScrollCommand",
     DEF_HTML_SCROLL_COMMAND, offsetof(HtmlWidget, xScrollCmd),
     TK_CONFIG_NULL_OK},
    {TK_CONFIG_STRING, "-yscrollcommand", "yScrollCommand", "ScrollCommand",
     DEF_HTML_SCROLL_COMMAND, offsetof(HtmlWidget, yScrollCmd),
     TK_CONFIG_NULL_OK},
#endif
    {TK_CONFIG_STRING, "-appletcommand", "appletCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zAppletCommand), 0},
    {TK_CONFIG_STRING, "-base", "base", "Base",
     "", offsetof(HtmlWidget, zBase), 0},
    {TK_CONFIG_STRING, "-scriptcommand", "scriptCommand", "HtmlCallback",
     "", offsetof(HtmlWidget, zScriptCommand), 0},
    {TK_CONFIG_STRING, "-formcommand", "formCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zFormCommand), 0},
    {TK_CONFIG_STRING, "-framecommand", "frameCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zFrameCommand), 0},
    {TK_CONFIG_INT, "-addendtags", "addendtags", "bool",
     0, offsetof(HtmlWidget, AddEndTags), 0},
    {TK_CONFIG_INT, "-tableborder", "tableborder", "int",
     0, offsetof(HtmlWidget, TableBorderMin), 0},
    {TK_CONFIG_INT, "-hasscript", "hasscript", "bool",
     0, offsetof(HtmlWidget, HasScript), 0},
    {TK_CONFIG_INT, "-hasframes", "hasframes", "bool",
     0, offsetof(HtmlWidget, HasFrames), 0},
    {TK_CONFIG_INT, "-hastktables", "hastktables", "bool",
     0, offsetof(HtmlWidget, HasTktables), 0},
    {TK_CONFIG_INT, "-tclhtml", "tclhtml", "bool",
     0, offsetof(HtmlWidget, TclHtml), 0},
    {TK_CONFIG_STRING, "-resolvercommand", "resolverCommand", "HtmlCallback",
     DEF_HTML_CALLBACK, offsetof(HtmlWidget, zResolverCommand), 0},
    {TK_CONFIG_BOOLEAN, "-sentencepadding", "sentencePadding",
     "SentencePadding", "0", offsetof(HtmlWidget, iSentencePadding), 0},
